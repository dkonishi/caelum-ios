...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    list.managedObjectContext = self.managedObjectContext;
    list.contatos             = self.contatos;
...
- (NSMutableArray *)buscaContatos
{
    NSFetchRequest *fr   = [NSFetchRequest fetchRequestWithEntityName:@"Contato"];
    NSSortDescriptor *sd = [NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES];
    [fr setSortDescriptors:@[sd]];

    NSArray *ci          = [self.managedObjectContext executeFetchRequest:fr error:nil];
    
    return [ci mutableCopy];
}
